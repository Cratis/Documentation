...
const overviewTopic = {
    ...
    items: [
        ...
        // Deliberately top-level and uncollapsed: this is the commercial front
        // door, so it must stay reachable in one click from anywhere in the docs.
        { label: 'Work with us', slug: 'work-with-us' },
        {
            label: 'Scenarios',
            collapsed: true,
            items: [
