...
Like the CLI and the [Chronicle MCP server](/ai/), Narrator is an *explore-and-inspect* tool. It reads the log and schemas; it doesn't change application state. To change state you still go through commands and events.
</Aside>
