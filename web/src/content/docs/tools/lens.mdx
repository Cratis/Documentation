...
in Kotlin and Java. See [Development users and tenants (C#)](/arc/backend/csharp/identity/development-and-topologies/)
or [Development users and tenants (Kotlin and Java)](/arc/backend/kotlin/guides/development-users-and-tenants/)
for how to implement a provider, and [Lens: Tenants and Users](https://github.com/Cratis/Lens/blob/main/Documentation/GettingStarted/TenantsAndUsers/index.md)
for screenshots of the extension working against seeded demo data.
...
<CardGrid>
  ...
  <SimpleCard title="Tenants and users, with screenshots" icon="seti:image" link="https://github.com/Cratis/Lens/blob/main/Documentation/GettingStarted/TenantsAndUsers/index.md">
    See the Context and Settings tabs against real seeded demo data, and how the roster is sourced from your Arc backend.
  </SimpleCard>
