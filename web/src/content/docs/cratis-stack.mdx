...
- You **model** the domain, and [Studio](/studio/) generates the C# for it.
...
Model in Studio, generate the slices, build them, inspect the result — an agent can take part at every step.
