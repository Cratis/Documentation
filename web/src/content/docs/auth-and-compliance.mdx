...
| --- | --- | --- |
| Identity provider | Where do browser users and API clients authenticate? | [AuthProxy authentication](/authproxy/configuration/authentication/) |
| Tenant resolution | Which host, claim, route, or configured value selects the tenant? | [AuthProxy tenancy](/authproxy/configuration/tenancy/) |
| Operation access | Which roles or policies can run each command or query? | [Arc authorization](/arc/backend/csharp/core/authorization/) |
| Compliance subject | Whose personal data does this event contain? | [Arc Chronicle subject](/arc/backend/csharp/chronicle/compliance/subject/) |
...
<CardGrid>
  ...
  <LinkCard title="Arc identity" description="Expose /.cratis/me and compose the identity details AuthProxy and the frontend consume." href="/arc/backend/csharp/identity/" />
  <LinkCard title="Arc authorization" description="Authorize commands and queries with attributes, roles, and policies before behavior runs." href="/arc/backend/csharp/core/authorization/" />
  <LinkCard title="Chronicle subject" description="Set the compliance subject so PII is encrypted under the correct identity." href="/arc/backend/csharp/chronicle/compliance/subject/" />
