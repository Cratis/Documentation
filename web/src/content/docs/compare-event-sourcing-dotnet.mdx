...
description: "A version-pinned, source-cited comparison of event sourcing options for .NET — KurrentDB (formerly EventStoreDB) 26.0, Marten 9.30.0, and Cratis Chronicle 17.0.0 — covering license, storage model, language clients, subscriptions, projections, and hosting, with citations and retrieval dates for every row."
head:
  - tag: meta
    attrs:
      name: keywords
