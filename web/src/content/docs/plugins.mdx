...
The configuration here is the *build* side — it teaches your assistant to write correct Cratis code. The *operate* side — letting an assistant inspect and diagnose a running store — is covered in [AI-native development](/ai/) (the CLI command catalog and the Chronicle MCP server).
</Aside>

## Where to go next

<CardGrid>
  <SimpleCard title="AI-native development" icon="rocket" link="/ai/">
