...
→ See [Plugins](/plugins/) for the full catalog of agents, skills, and coding rules — and how Claude Code and GitHub Copilot load them. The same conventions are enforced at compile time by the [code-analysis analyzers](/code-analysis/).
...
<CardGrid>
  ...
  <SimpleCard title="Code analysis" icon="approve-check" link="/code-analysis/">
    The Roslyn analyzers that enforce the same conventions at compile time.
  </SimpleCard>
