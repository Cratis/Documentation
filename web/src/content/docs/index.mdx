...
hero:
  ...
  tagline: Capture what happened as immutable facts, project them into exactly the read models you need, and ship a full-stack, type-safe app — identity, tenancy, backend, React, storage choice, and operations — without the boilerplate.
  image:
  ...
  actions:
    ...
    - text: GitHub
      ...
      variant: minimal
    - text: Discord
      link: https://discord.gg/kt4AMpV8WV
      variant: minimal
---
...
<CardGrid>
  ...
  <SimpleCard title="History when it matters" icon="seti:db" link="/chronicle/why-event-sourcing/">
    Chronicle records facts, projects read models, and lets you replay or react later instead of hoping today's row is enough.
  </SimpleCard>
...
Cratis is modular. You can start with the piece that matches the problem in front of you, then add the rest when the system asks for it.
