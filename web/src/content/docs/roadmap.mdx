...
| Area | Direction |
|---|---|
| Chronicle | Event log, event types, projections, reducers, reactors, subscriptions, storage choices, hosting, CLI inspection, and testing helpers — with a first-class .NET SDK and TypeScript, Kotlin/Java, and Elixir clients |
...
- The TypeScript, Kotlin/Java, and Elixir Chronicle clients and their documentation.
...
- A Python Chronicle client — coming soon; pre-release and not yet published.
- Ensemble, deterministic expert workflows for AI agents building with the Cratis stack — coming soon; pre-release, and free and MIT licensed like the rest of Cratis.
