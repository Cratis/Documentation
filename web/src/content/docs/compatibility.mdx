...
Cratis spans .NET packages, TypeScript packages, Docker images, storage engines, React components, Storybook, and documentation tooling. This page gives the current compatibility baseline used by the docs-overhaul source tree. For exact released package versions, use the package manager and repository release pages linked from [What's new](/whats-new/).
