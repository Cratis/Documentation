...
You won't touch this again for the slice below — it's here so you can see where the command, event, read model, and query you're about to write get wired in. The [Cratis package](/arc/backend/csharp/chronicle/cratis-package/) reference covers what `AddCratis` configures and how to adjust it.
...
- Backend: [Commands](/arc/backend/csharp/commands/) and [Queries](/arc/backend/csharp/queries/) in Arc, [Projections](/chronicle/projections/) in Chronicle.
