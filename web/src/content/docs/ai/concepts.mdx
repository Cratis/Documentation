...
description: The Cratis AI vocabulary mapped to the plugin concepts you already know — profiles, skills, subscriptions, corpus ownership, and channels.
---
...
| A managed package directory | **AI corpus** (`.cratis/ai`) | Selected Cratis rules and skills. Harness adapters point here; user-owned additions remain here too. |
...
- The **AI corpus** is one local source for every selected harness. Its
  manifest records installed hashes so updates can protect local changes.
