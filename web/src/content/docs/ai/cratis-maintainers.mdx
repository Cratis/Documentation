...
description: Follow the Cratis repository profile, managed AI corpus, skill, verification, review, and shipping workflow without copying the shared AI corpus between repositories.
---
...
2. **Read project-owned context**
   ...
   repositories may still use `.cratis/ai`; the controlled migration
   design uses `.cratis/ai` with small host bootstraps. Never replace,
   concatenate, or copy another repository's managed AI corpus.
