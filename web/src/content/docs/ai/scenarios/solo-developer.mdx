...
Marketplace installs follow the `Cratis/AI` default branch, and the npm
package is a supported stable release; the versioned-release flow is designed
but not published yet, waiting on the governed release gates. See
